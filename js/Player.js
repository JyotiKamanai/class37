class Player{
    ...
    getCount(){
        ...
        /* the line bellow reffers to to getting the value of the playerCount forom the data base and 
           storing it on our local variable playerCount.
        */
        playerCountRef.on("value",(data) => {
        // .val() function gets the value of the db coloumn that is being reffed using .ref().
        myPlayerCount = data.val();
        });
    }

    updateCount(count){
        // "/" reffers to root folder of the db. 
        db.ref("/").update({
            playerCount: count,
        });
    }
